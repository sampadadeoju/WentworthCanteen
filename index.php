...
<head>
    ...
    <title>Welcome | Wentworth Canteen | Wentworth Institute of Higher Education</title>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="d-flex text-center text-white position-relative promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to Wentworth Canteen</h1>
            <p class="lead fw-normal">Food ordering system of Wentworth Institute of Higher Education</p>
