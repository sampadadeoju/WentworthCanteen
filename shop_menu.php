...
<head>
    ...
    <title>Shop Menu | Wentworth Canteen</title> <!-- Updated title to reflect Wentworth context -->
</head>
    ...
    <div class="container px-5 py-4" id="shop-body">
                ...
                if($_GET["atc"]==1){
                    ...
                    <div class="row row-cols-1 notibar pb-3">
                        <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                            ...
                            <span class="ms-2 mt-2">Item added to your cart successfully!</span>
        ...
        <div class="mb-3 text-wrap" id="shop-header">
            <div class="rounded-25 mb-4" id="shop-img" style="
                    background: url(
                        <?php
                            if(is_null($shop_row["s_pic"])){echo "'img/default.png'";} // Default image if shop image is missing
                            else{echo "'img/{$shop_row['s_pic']}'";} // Custom image if available
                        ?>
            ...
            <ul class="list-unstyled">
                <li><?php echo $shop_row["s_location"];?></li>
                <li>Contact number: <?php echo "(+61) ".$shop_row["s_phoneno"];?></li> <!-- Updated phone number prefix for Australia -->
            </ul>
        </div>
                ...
                <div class="card rounded-25 mb-4">
                    <a href="food_item.php?<?php echo "s_id=".$food_row["s_id"]."&f_id=".$food_row["f_id"]?>" class="text-decoration-none text-dark">
                        <div class="card-img-top">
                            <img
                                <?php
                                if(is_null($food_row["f_pic"])){echo "src='img/default.png'";} // Default image if no food image
                                else{echo "src=\"img/{$food_row['f_pic']}\"";} // Custom food image
                                ?>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo $food_row["f_price"]?> AUD</p> <!-- Updated currency to AUD -->
