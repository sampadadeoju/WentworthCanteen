...
<head>
    ...
    <title>About Us | Wentworth Canteen</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal">Wentworth Institute of Higher Education</h4>
            <p class="mt-2 mb-3 fw-normal h6">Canteen Services</p>
            <p class="mb-3 fw-bold text-bold text-wrap">The Canteen Team</p>
            <h4 class="mt-2 mb-3 fw-normal">Canteen Manager</h4><p class="mt-2 mb-3 fw-normal h6">Mr. John Doe</p> <!-- Example manager name -->
