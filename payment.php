...
<head>
    ...
    <title>Payment | Wentworth Canteen</title>
</head>
    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            <div class="col mb-3 qr mb-md-0">
                <img src="img/qr.png" class="img-fluid rounded-25 float-start" alt="QR Code">
            </div>
            ...
            <form method="POST" action="add_order.php" class="form-floating">
                ...
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="cftid" placeholder="Confirm Transaction ID" minlength="12" maxlength="45" name="cftid" required>
                ...
                <div class="form-floating">
                    <div class="mb-2 form-check">
                        ...
                        <label class="form-check-label small" for="tandc">I agree to the terms and conditions and the privacy policy</label>
                    </div>
                </div>
