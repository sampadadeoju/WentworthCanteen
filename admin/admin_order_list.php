...
<head>
    ...
    <title>Order List | Wentworth Canteen</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <?php
            if(isset($_GET["search"])){
                ...
                AND orh.orh_orderstatus LIKE '%{$_GET['os']}%'".$cid_clause.$sid_clause." ORDER BY orh.orh_ordertime DESC;";
            } else {
                $query = "SELECT orh.orh_id, orh.orh_ordertime, c.c_firstname, c.c_lastname, orh.orh_orderstatus, p.p_amount, s.s_name, orh.t_id
            ...
            <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row["p_amount"]." AUD";?></td>
                        <td>
    ...
    <?php } else { ?>
    <div class="container align-items-center justify-content-center py-3">
