...
<head>
    ...
    <title>Update Customer Password | Wentworth Canteen</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="admin_customer_pwd.php" class="form-floating">
            ...
            <button class="w-100 btn btn-success my-3" name="rst_confirm" type="submit" onclick="return confirm('Do you want to update this customer\'s password?');" >Update Password</button>
        </form>
    </div>
