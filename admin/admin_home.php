...
<head>
    ...
    <title>Admin Dashboard | Wentworth Canteen</title>
</head>
...
<body class="d-flex flex-column">
    ...
    <div class="d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-3">
            ...
            <p class="lead fw-normal">Wentworth Institute of Higher Education Canteen Management System</p>
        </div>
    </div>
