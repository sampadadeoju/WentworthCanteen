...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold text-wrap">Wentworth Institute of Higher Education Canteen</p>
            <p class="mb-3">Serving fresh and affordable Australian meals to all students and staff.</p>
