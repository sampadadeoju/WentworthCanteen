...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <div class="container row row-cols-6 row-cols-md-12 g-5 pt-4 mb-4" id="shop-header">
            <div class="rounded-25 col-6 col-md-4" id="shop-img" style="background: url(
                <?php
                    if(is_null($shop_row["s_pic"])){echo "'../img/default.png'";}
                    else{echo "'../img/{$shop_row['s_pic']}'";}
                ?>) center; height: 225px; background-size: cover; background-repeat: no-repeat; object-fit: fill; background-position: center;">
            </div>
        ...
        <div class="container">
            <h3 class="border-top pt-3 my-2">
                ...
                <a class="nav-item text-decoration-none link-secondary" href="admin_shop_order.php?s_id=<?php echo $s_id?>">Orders</a>
                <span class="text-secondary">/</span> 
                <a class="nav-item text-decoration-none link-secondary" href="admin_shop_revenue.php?s_id=<?php echo $s_id?>">Revenue</a>
            </h3>
            ...
            <div class="table-responsive">
                <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                    <caption><?php echo $numrow;?> item(s) <?php if(isset($_GET["search"])){?><br /><a
                            href="admin_shop_detail.php?s_id=<?php echo $s_id?>" class="text-decoration-none text-danger">Clear Search Result</a><?php } ?></caption>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php printf("%.2f AUD", $row["f_price"]);?></td>
                            <td>
