...
<head>
    ...
    <title>Revenue Report | Wentworth Canteen</title>
</head>
        ...
        <form method="GET" action="shop_report_summary.php" class="form-floating">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="rev_mode3">
                    ...
                    echo "{$week_start} - {$week_end}"; // Showing range in Sydney format
                    ?>)
                </label>
            </div>
            <div class="form-check">
                ...
                <label class="form-check-label" for="rev_mode4">
                    ...
                    echo "{$month_start} - {$month_end}"; // Showing the current month in Sydney format
                    ?>)
                </label>
            </div>
            <div class="form-check">
