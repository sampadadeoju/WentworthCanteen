<header class="navbar navbar-expand-md navbar-light bg-light fixed-top shadow-sm mb-auto">
  <div class="container-fluid mx-4">
    <a class="navbar-brand" href="index.php">
        <img src="img/Color logo - no background.png" alt="WentworthCanteen LOGO" width="125" class="me-2">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item">
          <a class="nav-link px-2 text-dark" href="shop_list.php">Canteen Menu</a>
        </li>
