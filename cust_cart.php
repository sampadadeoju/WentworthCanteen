...
<head>
    ...
    <title>My Cart | WENTWORTH CANTEEN</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4">
            ...
            <!-- Success and Failure Messages for Cart Update -->
            <?php 
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex border-0 pb-3 border-bottom w-100 justify-content-between align-items-center">
                                <div class="image-parent">
                                    <img <?php if (is_null($row["f_pic"])) { echo "src='img/default.png'"; } else { echo "src=\"img/{$row['f_pic']}\""; } ?> class="img-fluid rounded" style="width: 100px; height:100px; object-fit:cover;" alt="f_pic">
                                </div>
                                <div class="ms-3 mt-3 me-auto">
                                    <div class="fw-normal"><span class="h5"><?php echo $row["ct_amount"] ?>x</span> <?php echo $row["f_name"] ?>
                                        <p><?php printf("%.2f AUD <small class='text-muted'>(%.2f AUD each)</small>", $row["f_price"] * $row["ct_amount"], $row["f_price"]) ?><br />
                        ...
                        <div class="col my-3">
                            <ul class="list-inline justify-content-between">
                                <li class="list-item mb-2">
                                    <a href="remove_cart_all.php?rmv=1&s_id=<?php echo $cart_result["s_id"]; ?>" class="nav nav-item text-danger text-decoration-none small" name="rmv_all" id="rmv_all">Remove all item in cart</a>
                                </li>
            ...
            <div class="col mt-3 mt-md-0">
                <div class="row row-cols-1">
                    ...
                    <!-- Place Order Button (disabled if less than minimum cost) -->
                    <?php if ($no_order) { ?>
