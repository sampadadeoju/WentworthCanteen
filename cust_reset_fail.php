...
<head>
    ...
    <title>Reset Password Failed | Wentworth Canteen</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center reg-fail mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold">Sorry, we have encountered an error.<br/>
                <code>
                    <?php
                        $error_code = $_GET["err"];
                        if ($error_code == 1062){
                            echo "The account details provided do not match.";
                        }else{
